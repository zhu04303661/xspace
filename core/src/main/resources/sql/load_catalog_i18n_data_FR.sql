...
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-256, 3, 'fr', 'Sku', 'longDescription', 'Tangy, venu de Cayenne poivron flux avec l''ail, l''oignon p&acirc;te de tomate, et un so de sucre de canne pour en faire une sauce onctueuse avec une morsure. Magnifique sur les, la volaille, le porc ou le poisson, cette sauce marie pour faire des marinades et des soupes riches.');
...
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-260, 5, 'fr', 'Sku', 'longDescription', 'Si vous voulez chaud, c''est le piment de choisir. Originaire de la Care, du Yucatan et du Nord  de l''Am&eacute;rique du Sud, le Habanero se pr&eacute;sente dans une vari&eacute;t&eacute; de couleurs allant du vert p&acirc;le au rouge vif. La chaleur gras Habanero, la saveur et l''a unique, en a fait le favori des amateurs de chili.');
...
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-268, 9, 'fr', 'Sku', 'longDescription', 'Tout l''enfer se d&eacute;che, le feu et le soufre pleuvoir? se pr&eacute;parer &agrave; rencontrer votre machine?');
...
INSERT INTO BLC_TRANSLATION (TRANSLATION_ID, ENTITY_ID, LOCALE_CODE, ENTITY_TYPE, FIELD_NAME,  TRANSLATED_VALUE) VALUES (-279, 15, 'fr', 'Sku', 'name', 'Sauce &agrave; l''ail i chaud');
